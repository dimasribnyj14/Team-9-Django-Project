...
function solveAmount() {
    ...
    everyPrice.textContent = `Ціна усіх продуктів: ${String(sumPriceProduct)}$`
}
...
listRemove.forEach(function (remove, id, listRemove) {
    remove.addEventListener("click", function (event) {
        let removeClass = remove.className.split(" ")[1]
        let textObject = document.querySelector(`#${removeClass}`)
